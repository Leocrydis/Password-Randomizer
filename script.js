...
function generatePassword() {
  ...
  //ask user for a password lenght
  var characterCount = window.prompt("How many characters would you like you password ot be? please chose a length between 8 and 128")
